...
SERVICES3="$(ls /usr/share/applications/bigcontrolcenter/* | grep -ve timeshift-gtk.desktop -ve cups.desktop -ve htop.desktop -ve system-config-printer.desktop -ve msm_kde_notifier_settings.desktop -ve mpv.desktop -ve manjaro-settings-manager.desktop -ve org.kde.kuserfeedback-console.desktop -ve qvidcap.desktop -ve kdesettings -ve lstopo.desktop -ve kdesystemsettings.desktop)"
